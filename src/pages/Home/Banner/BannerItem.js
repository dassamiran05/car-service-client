...
const BannerItem = ({slide}) => {
    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full">
            ...
            <div className="absolute flex justify-end transform -translate-y-1/2 w-2/5 left-24" style={{top:'53%'}}>
            ...
            <div className="absolute flex justify-start transform -translate-y-1/2 w-2/5 left-24" style={{bottom:"30%"}}>
